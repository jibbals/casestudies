# -*- coding: utf-8 -*-
"""
Created on Wed Dec  8 15:07:12 2021
...
from utilities import transects as transect_utils

# For looking at firefronts transects
firefront_centres = {
    'KI_run1':{
    ...
    for umdtime in umdtimes:
        ...
        for i,dtime in enumerate(dtimes):
            for transecti, transect in enumerate(transect_list):
                ...
                if temperature:
                    transect_utils.plot_transect_theta(T, z, lat, lon, start, end,
                                                npoints=npoints,
                                                topog=topogd, 
                                                sh=shi,
                                                ztop=ztop,
                ...
                retdict = transect_utils.plot_transect_winds(u, v, w, z, lat, lon, transect, 
                                       ztop=ztop,
                                       )
    ...
    for umdtime in umdtimes:
        ...
        for ti,dtime in enumerate(dtimes):
            ...
            for trani,transect in enumerate(transects):
                ...
                wind_transect_struct = transect_utils.plot_transect_winds(ui, vi, wi, zi, lats, lons, 
                                                      transect,
                                                      ztop=ztop,
                                                      npoints=npoints,
                                                      #topog=topog,
